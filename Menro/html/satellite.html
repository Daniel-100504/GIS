...
<head>
  ...
  <link rel="icon" href="../../assets/calatagan-seal.png"/>
        ...
        <link rel="stylesheet" href="../css/side-menu.css?v=2"/>
    ...
    <div class="layers-popup">
        ...
        <div class="layer-tile-grid">
            ...
            <label class="layer-tile">
                <input type="checkbox" id="layerSentinel2" class="layer-tile-input">
            ...
            <label class="layer-tile">
                <input type="checkbox" id="layerNdvi" class="layer-tile-input">
                ...
                <span class="layer-tile-label">NDVI</span>
            </label>

            <label class="layer-tile">
                <input type="checkbox" id="layerZones" class="layer-tile-input" checked>
                <span class="layer-tile-icon layer-tile-icon-zones" aria-hidden="true">
                    <span class="layer-tile-art">
                        <span class="layer-tile-dot" style="top:28%;left:32%;"></span>
                        <span class="layer-tile-dot" style="top:52%;left:60%;"></span>
                        <span class="layer-tile-dot" style="top:68%;left:30%;"></span>
                    </span>
                    <span class="layer-tile-badge">
...
<div class="map-legend">
    <p class="map-legend-title">Zone Health</p>
    <div class="map-legend-row"><span class="map-legend-dot healthy"></span>Healthy</div>
    <div class="map-legend-row"><span class="map-legend-dot moderate"></span>Moderate</div>
    <div class="map-legend-row"><span class="map-legend-dot degraded"></span>Degraded</div>
    <div class="map-legend-row"><span class="map-legend-dot pending"></span>Pending</div>
</div>
...
<input type="hidden" id="sceneDate">
    ...
    <div class="scene-calendar">
        ...
        <div class="scene-calendar-legend">
            ...
            <span><i class="cal-dot cal-dot-cc-ok"></i> Meets cloud limit</span>
    ...
    <div class="settings-group">
        ...
        <p id="zoneSearchHint" class="zone-search-hint">
            Type a barangay name to filter
        </p>
    ...
    <div class="dashboard-modal-body">
      ...
      <div class="guide-section">
        ...
        <div class="guide-item">
          ...
          <div class="guide-text">
            <h3>Layers</h3>
            <p>Hover over the <strong>Layers</strong> button (bottom-left of the map) to toggle Sentinel-2 imagery, NDVI overlay, and Mangroves markers. Click the button itself to switch the base map between <strong>Map</strong> and <strong>Satellite</strong> view.</p>
          </div>
        </div>
        ...
        <div class="guide-item">
          ...
          <div class="guide-text">
            ...
            <p>Picking a Scene Date automatically syncs each zone's satellite NDVI in the background — this can take a moment.</p>
          </div>
        </div>
        ...
        <div class="guide-item">
          ...
          <div class="guide-text">
            ...
            <p>In the Scene Date calendar, dates with any Sentinel-2 imagery are shaded light green; dates that also meet your <strong>Max. cloud coverage</strong> limit turn a bolder green. Clicking a highlighted date automatically turns on the Sentinel-2 layer so the imagery shows right away.</p>
          </div>
        </div>
        ...
        <div class="guide-item">
          ...
          <div class="guide-text">
            <h3>KoboToolbox</h3>
            <p>Field surveys sync automatically — a zone updates on its own once a ranger submits one.</p>
          </div>
        </div>
      </div>
      ...
      <div class="guide-section">
        ...
        <div class="guide-item">
          ...
          <div class="guide-text">
            <h3>Export Report</h3>
            <p>Choose <strong>Export Field Survey Report</strong> from the menu, then pick PDF or Excel to download all recorded field surveys.</p>
          </div>
        </div>
...
<div class="dashboard-overlay" id="exportReportOverlay">
  ...
  <div class="confirm-modal export-modal">
    ...
    <p class="confirm-modal-text">Choose a file format to download all recorded field survey submissions.</p>

    <div class="export-format-group">

      <label class="export-format-option">
        <input type="radio" name="exportFormat" value="pdf" class="export-format-input" checked>
        <span class="export-format-check">
      ...
      <label class="export-format-option">
        <input type="radio" name="exportFormat" value="excel" class="export-format-input">
        <span class="export-format-check">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
        </span>
        <span class="export-format-icon">
...
<aside class="side-menu" id="sideMenu">
  ...
  <div class="side-menu-body">
    ...
    <button class="side-menu-item" id="menuMap">
    ...
    <button class="side-menu-item" id="menuGuide">
      <span class="side-menu-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<script src="../js/kobo-data.js"></script>
<script src="../js/map-core.js"></script>
<script src="../js/zones-panel.js"></script>
<script src="../js/scene-calendar.js"></script>
<script src="../js/export-report.js?v=5"></script>
