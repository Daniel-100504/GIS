...
<body>
  ...
  <div class="shell">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <button class="nav-item" data-view="submit" onclick="switchView('submit', this)">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        <button class="nav-item" data-view="history" onclick="switchView('history', this)">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <main class="main">
      ...
      <section class="view active" id="view-dashboard">
        ...
        <div class="panel alert-panel" id="water-quality-alert" style="display:none;">
      ...
      <section class="view" id="view-submit">
        <div class="panel form-panel">
          ...
          <div class="kobo-note">
            Complete the form below. Data is submitted to MENRO via KoboToolbox and will appear on the monitoring map
            after review.
          </div>
          <div class="kobo-wrap">
            <iframe id="kobo-form-frame" src="https://ee.kobotoolbox.org/i/BtpXWgyE" width="100%" height="620" frameborder="0"
              title="Mangrove Field Data Submission Form" style="border-radius:8px;border:1.5px solid var(--border-strong);">
            </iframe>
          </div>
        </div>
      </section>
          ...
          <table class="history-table">
            ...
            <thead>
              <tr>
                ...
                <th class="cell-right">Canopy Cover</th>
                <th class="cell-center">Water Quality</th>
  ...
  <div class="confirm-overlay" id="deleteOverlay">
    <div class="confirm-modal">
      ...
      <div class="confirm-modal-text">This will permanently remove the field record from KoboToolbox. This action cannot be undone.</div>
      <div class="confirm-modal-actions">
  ...
  <script src="ranger.js?v=3"></script>
</body>
